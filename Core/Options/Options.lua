...
NUI.Options = {
	...
	args = {
		addonprofiles = {
			...
			order = 1,
			hidden = function()
				if NUI:IsAddOnEnabled("QuaziiUI") or not NUI:IsAddOnEnabled("NaowhUI_Data") or NUI:IsAddOnEnabled("ElvUI") or AreAddOnsDisabled() then
					return true
				end
			end,
			type = "group",
		...
		classweakauras = {
			...
			order = 2,
			hidden = function()
				if NUI:IsAddOnEnabled("QuaziiUI") or not NUI:IsAddOnEnabled("NaowhUI_Data") or not NUI:IsAddOnEnabled("WeakAuras") then
					return true
				end
			end,
			type = "group",
		...
		generalweakauras = {
			...
			order = 3,
			hidden = function()
				if NUI:IsAddOnEnabled("QuaziiUI") or not NUI:IsAddOnEnabled("NaowhUI_Data") or NUI:IsAddOnEnabled("ElvUI") or not NUI:IsAddOnEnabled("WeakAuras") then
					return true
				end
			end,
			type = "group",
		...
		advanced = {
			...
			args = {
				loadprofiles = {
					...
					hidden = function()
						if NUI:IsAddOnEnabled("QuaziiUI") or not NUI:IsAddOnEnabled("NaowhUI_Data") or NUI:IsAddOnEnabled("ElvUI") or AreAddOnsDisabled() or not NUI.db.global.profiles then
							return true
						end
					end,
					type = "execute",
