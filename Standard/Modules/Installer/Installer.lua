...
I.installer = {
	...
	Pages = {
		...
		[10] = function()
			...
			PluginInstallFrame.Option2:Show()
			PluginInstallFrame.Option2:SetScript("OnClick", function() SE:Setup("WeakAuras", nil, nil, PluginInstallFrame, "HIGH", "raid") end)
			PluginInstallFrame.Option2:SetText("Raid")
			PluginInstallFrame.Option3:Show()
			PluginInstallFrame.Option3:SetScript("OnClick", function() SE:Setup("WeakAuras", nil, nil, PluginInstallFrame, "HIGH", "generic") end)
			PluginInstallFrame.Option3:SetText("M+ Generic")
			PluginInstallFrame.Option4:Show()
			PluginInstallFrame.Option4:SetScript("OnClick", function() SE:Setup("WeakAuras", nil, nil, PluginInstallFrame, "HIGH", "Season2") end)
			PluginInstallFrame.Option4:SetText("M+ Season 2")
		end,
		[11] = function()
