	...
	Pages = {
		...
		[6] = function()
			if not NUI:IsAddOnEnabled("NameplateAuras") then
				PluginInstallFrame.SubTitle:SetText("Enable NameplateAuras to unlock this functionality.")
		...
		[7] = function()
			if not NUI:IsAddOnEnabled("OmniCD") then
				PluginInstallFrame.SubTitle:SetText("Enable OmniCD to unlock this functionality.")
		...
		[9] = function()
			if not NUI:IsAddOnEnabled("WarpDeplete") then
				PluginInstallFrame.SubTitle:SetText("Enable WarpDeplete to unlock this functionality.")
		...
		[10] = function()
			...
			PluginInstallFrame.Option2:Show()
			PluginInstallFrame.Option2:SetScript("OnClick", function() SE:Setup("WeakAuras", nil, nil, PluginInstallFrame, "HIGH", NUI.Generic) end)
			PluginInstallFrame.Option2:SetText("Raid")
			PluginInstallFrame.Option3:Show()
			PluginInstallFrame.Option3:SetScript("OnClick", function() SE:Setup("WeakAuras", nil, nil, PluginInstallFrame, "HIGH", NUI.Raid) end)
			PluginInstallFrame.Option3:SetText("Generic")
			PluginInstallFrame.Option4:Show()
			PluginInstallFrame.Option4:SetScript("OnClick", function() SE:Setup("WeakAuras", nil, nil, PluginInstallFrame, "HIGH", NUI.Season2) end)
